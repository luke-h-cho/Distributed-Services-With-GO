...
func setupTest(t *testing.T, fn func(*Config)) (client1 api.LogClient, client2 api.LogClient, cfg *Config, teardown func()) {
	t.Helper()
...
func testUnauthorized(
	...
	if gotCode != wantCode {
		t.Fatalf("got code %s, instead of %s", gotCode, wantCode)
	}
